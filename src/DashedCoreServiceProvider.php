...
class DashedCoreServiceProvider extends PackageServiceProvider
{
    ...
    public function bootingPackage()
    {
        ...
        cms()
            ...
            ->emailBlock('media-text', MediaTextBlock::class)
            ->emailBlock('callout', CalloutBlock::class)
            ->emailBlock('video', VideoBlock::class)
            ->emailBlock('quote', QuoteBlock::class)
            ->emailBlock('html', HtmlBlock::class);
...
MARKDOWN,
    ...
    public function configurePackage(Package $package): void
    {
        ...
        cms()->registerSettingsPage(\Dashed\DashedCore\Filament\Pages\Settings\CleanupSettingsPage::class, 'Opschonen', 'trash', 'Bewaartermijnen van alle aangemelde logboeken en tabellen');
        ...
        $package
            ...
            ->hasCommands([
                ...
                \Dashed\DashedCore\Commands\ScrubSentEmailsCommand::class,
