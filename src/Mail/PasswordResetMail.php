...
class PasswordResetMail extends Mailable
{
    ...
    {
        $view = view()->exists(config('dashed-core.site_theme', 'dashed') . '.emails.password-reset') ? config('dashed-core.site_theme', 'dashed') . '.emails.password-reset' : 'dashed-core::emails.password-reset';
