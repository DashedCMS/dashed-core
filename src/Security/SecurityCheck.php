...
class SecurityCheck
{
    ...
    public static function run(?Request $request = null): array
    {
        ...
        $items[] = self::item('app_url_https', __('APP_URL op https'),
        ...
        $items[] = self::item('session_secure', __('Sessiecookie alleen over https'),
        ...
        $items[] = self::item('session_encrypt', __('Sessie-inhoud versleuteld'),
        ...
        $items[] = self::item('trusted_proxies', __('Vertrouwde proxy\'s'),
        ...
        $items[] = self::item('trusted_hosts', __('Vertrouwde hosts'),
        ...
        $items[] = self::item('ip_allowlist', __('IP-beperking op het CMS'),
        ...
        $items[] = self::item('idle_timeout', __('Automatisch uitloggen'),
        ...
        $items[] = self::item('mfa_reverify', __('MFA opnieuw bevestigen'),
        ...
        $withoutMfa = User::query()
            ...
            ->pluck('email')
            ->all();
        $items[] = self::item('mfa_users', __('Beheerders met MFA'),
        ...
        $items[] = self::item('security_alerts', __('Beveiligingsmeldingen'),
        ...
        $items[] = self::item('rate_limits', __('Verzoeklimieten'),
        ...
        $items[] = self::item('security_headers', __('Beveiligingsheaders'),
        ...
        $items[] = self::item('passwords', __('Wachtwoordeisen'),
        ...
        $items[] = self::item('robots', __('robots.txt'),
