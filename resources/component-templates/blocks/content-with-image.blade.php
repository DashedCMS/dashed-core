<div class="relative isolate overflow-hidden bg-white px-6 @if($data['top_margin']) pt-16 sm:pt-24 @endif @if($data['bottom_margin']) pb-16 sm:pb-24 @endif lg:overflow-visible lg:px-0">
