<div wire:poll.20s="heartbeat" class="dashed-edit-presence">
    @if (! empty($editors))
        ...
        <div class="fi-section mb-4 rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-500/40 dark:bg-amber-500/10 dark:text-amber-200" role="status" aria-live="polite">
